...
const STEPS_META = [
  { step: 1, title: 'Choose Video', icon: Upload, desc: 'Upload or pick sample' },
  { step: 2, title: 'Transcribe', icon: Mic, desc: 'Automatic captions' },
  { step: 3, title: 'Best Moments', icon: Sparkles, desc: 'Find top highlights' },
  { step: 4, title: 'Trim Clip', icon: Scissors, desc: 'Fine-tune start & end' },
  { step: 5, title: 'Style & Look', icon: Palette, desc: 'Captions & framing' },
  { step: 6, title: 'Create Reel', icon: Cpu, desc: 'Processing your video' },
  { step: 7, title: 'Download', icon: CheckCircle, desc: 'Ready to share' },
];
