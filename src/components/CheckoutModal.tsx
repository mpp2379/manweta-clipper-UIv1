        ...
        <div className="p-6 overflow-y-auto space-y-6 flex-1">
              ...
              <div className="p-5 rounded-3xl bg-[#111111] border border-[#222222] flex items-center justify-between">
                <div>
                  ...
                  <span className="text-xs text-[#888888]">
                    {selectedPlan.minutesPerMonth} credits/month • {billingCycle === 'yearly' ? 'Annual Plan' : 'Monthly Plan'}
                  </span>
                </div>
          ...
          {step === 'success' && (
            <div className="text-center py-8 space-y-4 max-w-md mx-auto animate-in zoom-in">
              ...
              <p className="text-xs text-[#888888]">
                Your account has been upgraded to <strong className="text-white font-medium">{selectedPlan.name}</strong>. {selectedPlan.minutesPerMonth} priority 4K rendering credits have been added to your balance.
              </p>
